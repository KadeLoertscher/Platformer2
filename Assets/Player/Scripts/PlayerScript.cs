...
public class PlayerScript : MonoBehaviour
{
    ...
    private void Awake()
    {
      ...
      /*  if ((SceneManager.GetActiveScene().buildIndex != PlayerPrefs.GetInt("CurLevel")) && PlayerPrefs.HasKey("x"))
        {
        ...
        {
            startPos = new Vector3(PlayerPrefs.GetFloat("x"), PlayerPrefs.GetFloat("y"), PlayerPrefs.GetFloat("z"));
        }
        else
        {
    ...
    public void die()
    {
        /*PlayerPrefs.SetFloat("x", startPos.x);
        PlayerPrefs.SetFloat("y", startPos.y);
        PlayerPrefs.SetFloat("z", startPos.z);*/
